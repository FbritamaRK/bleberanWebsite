        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            {[
              ...
              { label: 'Armada Kapal', val: '5+', sub: 'Wisata Air', color: 'bg-sky-500 shadow-sky-200' },
              { label: 'Pengusaha Lokal', val: '5+', sub: 'UMKM Terdaftar', color: 'bg-orange-500 shadow-orange-200' },
